    ...
    window.onload = function () {
        if (g_firstOnLoad) {
            ...
            $("iSettings").addEventListener("click", function () {
                if (!g_theme_imgs) {
                    g_theme_imgs = true;
                    $("t_europe").src = "Images/flowers/theme.png";
                    $("t_africa").src = "Images/flowers/theme.png";
                    $("t_asia").src = "Images/flowers/theme.png";
                    $("t_america").src = "Images/flowers/theme.png";
                    $("t_animals").src = "Images/flowers/theme.png";
                    $("t_flowers").src = "Images/flowers/theme.png";
                    $("t_tricky").src = "Images/flowers/theme.png";
                    $("t_mascha").src = "Images/flowers/theme.png";
                    $("t_mascha2").src = "Images/flowers/theme.png";
                    $("t_mascha3").src = "Images/flowers/theme.png";
                    $("t_mascha4").src = "Images/flowers/theme.png";
                    $("t_shrek").src = "Images/flowers/theme.png";
                }
